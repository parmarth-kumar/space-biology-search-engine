...
const iconSvgs = {
  ...
  leaf: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 4 13q0-4.5 7-10 7 5.5 7 10a7 7 0 0 1-7 7Z"/><path d="M11 20v-9"/></svg>`,
  ...
  rocket: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.05A7.3 7.3 0 0 0 5 5.5c0-1.5.5-2.5 2-3l2.5-2.5c.78-.78 2.05-.78 2.83 0l2.5 2.5c1.5.5 2 1.5 2 3a7.3 7.3 0 0 1-2.55 5.05c-.65.75-.66 2.21.05 3.05 1.26 1.5 5 2 5 2s-.74-3.5-2-5-2.5-2-5-2-3.74.5-5 2z"/><path d="M9 18a6 6 0 0 1 6 0"/></svg>`,
  ...
  brain: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15A2.5 2.5 0 0 1 9.5 22h-3A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2h3Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 2.5 2.5h3A2.5 2.5 0 0 0 20 19.5v-15A2.5 2.5 0 0 0 17.5 2h-3Z"/><path d="M9 12h6"/><path d="M9 16h6"/></svg>`,
  flask: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2v10.3A5.002 5.002 0 0 0 12 22a5 5 0 0 0 3-1.7V2"/><path d="M6 12h12"/></svg>`,
  virus: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 8 2 2"/><path d="m12 16 2-2"/><path d="m12 8-2 2"/><path d="m12 16-2-2"/><path d="M7.6 7.6 6 6"/><path d="m18 6-1.6 1.6"/><path d="m6 18 1.6-1.6"/><path d="m16.4 16.4 1.6 1.6"/></svg>`,
  planet: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M18.83 14.24c1.17-2.12.7-4.8-1.08-6.58C16.03 5.95 13.46 5.5 12 6.05c-1.46.56-2.58 1.68-3.05 3.13-1.12 3.42.92 7.04 4.34 8.16 3.42 1.12 7.04-.92 8.16-4.34Z"/><path d="m15 15-.8-2.3-2.3-.8.8-2.3 2.3.8Z"/><path d="M9 6h.01"/><path d="M5 14h.01"/><path d="m20 18-.8-2.3-2.3-.8.8-2.3 2.3.8Z"/></svg>`,
  satellite: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 10.5c-2.5 2.5-2.5 6.5 0 9s6.5 2.5 9 0"/><path d="m18 12-6-6"/><path d="m13 7 5 5"/><path d="m22 2-3 1 1 4 2-3"/><path d="M11 13 8 10l-1.5 1.5 4.5 4.5 1.5-1.5Z"/></svg>`,
};
